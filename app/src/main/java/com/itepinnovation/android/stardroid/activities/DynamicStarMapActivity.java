...
import com.itepinnovation.android.stardroid.activities.util.ActivityLightLevelChanger;
import com.itepinnovation.android.stardroid.activities.util.ActivityLightLevelChanger.NightModeable;
import com.itepinnovation.android.stardroid.activities.util.ActivityLightLevelManager;
import com.itepinnovation.android.stardroid.activities.util.FullscreenControlsManager;
import com.itepinnovation.android.stardroid.activities.util.GooglePlayServicesChecker;
import com.itepinnovation.android.stardroid.base.Lists;
import com.itepinnovation.android.stardroid.control.AstronomerModel;
import com.itepinnovation.android.stardroid.control.ControllerGroup;
import com.itepinnovation.android.stardroid.control.MagneticDeclinationCalculatorSwitcher;

import com.itepinnovation.android.stardroid.math.CoordinateManipulationsKt;
import com.itepinnovation.android.stardroid.renderer.RendererController;
import com.itepinnovation.android.stardroid.renderer.SkyRenderer;

import com.itepinnovation.android.stardroid.renderer.util.SearchHelper;
import com.itepinnovation.android.stardroid.renderer.util.TextureManager;
import com.itepinnovation.android.stardroid.renderer.util.TextureReference;
import com.itepinnovation.android.stardroid.renderer.util.TexturedQuad;
import com.itepinnovation.android.stardroid.util.Analytics;
import com.itepinnovation.android.stardroid.util.AnalyticsInterface;

import com.itepinnovation.android.stardroid.util.FixedPoint;
import com.itepinnovation.android.stardroid.views.ButtonLayerView;
import com.itepinnovation.android.stardroid.ApplicationConstants;
import com.itepinnovation.android.stardroid.inject.HasComponent;
...
import com.itepinnovation.android.stardroid.search.SearchResult;
import com.itepinnovation.android.stardroid.touch.DragRotateZoomGestureDetector;
import com.itepinnovation.android.stardroid.touch.GestureInterpreter;
import com.itepinnovation.android.stardroid.touch.MapMover;
import com.itepinnovation.android.stardroid.util.MiscUtil;
import com.itepinnovation.android.stardroid.util.SensorAccuracyMonitor;
 ...
 */
  ...
  protected void onRestoreInstanceState(Bundle icicle) {
    ...
    if (searchMode) {
      ...
      Log.d(TAG, "Searching for" + searchTargetName + " at target=" + searchTarget);
  ...
  protected void onSaveInstanceState(Bundle icicle) {
    ...
    SearchArrow test= new SearchArrow();
     sin = test.sindegeri;
    cos = test.cosdegeri;
  ...
  public void activateSearchTarget(Vector3 target, final String searchTerm) {
    ...
    String[] cars = {String.valueOf(target.x),String.valueOf(target.y)};
   //  sendSignal(Float.toString(target.x),Float.toString(target.y));
    //************************

    String string= String.valueOf(Float.toString(target.x).getBytes());
  ...
  public static void sendSignal(String number, String number2) {
    if ( btSocket != null ) {
      try {
        btSocket.getOutputStream().write(number.toString().getBytes());
        btSocket.getOutputStream().write(number2.toString().getBytes());

        Log.e("basarılı","Basarılı data");
      } catch (IOException e) {
        Log.e("basarısız","Basarısız data");
      }
    }
  }
...
*/
 ...
 /* @Override
  ...
  public static class SearchArrow {
    ...
    public float cosdegeri;
    public float sindegeri;
    ...
    public void draw(GL10 gl, Vector3 lookDir, Vector3 upDir, SearchHelper searchHelper,
      ...
      //***********
      float diffPhiInDegrees = (float) Math.toDegrees(diffPhi);
      float diffThetaInDegrees = (float) Math.toDegrees(diffTheta);

      Log.e("diffThetaInDegrees","diffThetaInDegrees"+diffThetaInDegrees);
      Log.e("diffPhiInDegrees","diffPhiInDegrees"+diffPhiInDegrees);
      //*********************
      sendSignal(Float.toString(diffPhiInDegrees),Float.toString(diffThetaInDegrees));
    ...
    public float angleBetweenVectorsWithRespectToAxis(Vector3 v1, Vector3 v2, Vector3 axis) {
      ...
      cosAngle = v1proj.dot(v2);
      sinAngle = -perp.dot(v2);


      cosdegeri = cosAngle;
      sindegeri = sinAngle;
     //Log.e("ok","yön kordinatı = "+ cosdegeri + "   " + sindegeri);
