...
return may;
  ...
  public void setTarget(Vector3 position) {
    ...
    Log.e("ok","yön"+ mTargetPhi + mTargetTheta);
  }
  ...
  // vectors and v2 and axis are perpendicular.
   static float angleBetweenVectorsWithRespectToAxis(Vector3 v1, Vector3 v2, Vector3 axis) {
  ...
  Log.e("ok","yön"+ cosAngle + sinAngle);
